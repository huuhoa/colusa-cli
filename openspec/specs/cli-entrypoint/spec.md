...
Define how the CLI entrypoint loads configuration and applies it alongside user-supplied flags, including SSL cert resolution, default overrides, automatic site rule application, and per-site browser mode.
